...
#ifndef SAILFISHSECRETS_PLUGIN_CRYPTOSTORAGE_EXAMPLECRYPTOSTORAGEPLUGIN_PLUGIN_H
#define SAILFISHSECRETS_PLUGIN_CRYPTOSTORAGE_EXAMPLECRYPTOSTORAGEPLUGIN_PLUGIN_H
...
class Q_DECL_EXPORT ExampleCryptoStoragePlugin : public QObject
...
public:
    ExampleCryptoStoragePlugin(QObject *parent = Q_NULLPTR);
    ~ExampleCryptoStoragePlugin();

    QString displayName() const Q_DECL_OVERRIDE {
        return qtTrId("Example Crypto Storage Plugin");
    }
    QString name() const Q_DECL_OVERRIDE {
#ifdef SAILFISHSECRETS_TESTPLUGIN
        return QLatin1String("org.sailfishos.secrets.plugin.cryptostorage.examplecryptostorageplugin.test");
#else
        return QLatin1String("org.sailfishos.secrets.plugin.cryptostorage.examplecryptostorageplugin");
#endif
    }
...
private:
    ...
    Sailfish::Crypto::Key m_builtInKey;
...
#endif // SAILFISHSECRETS_PLUGIN_CRYPTOSTORAGE_EXAMPLECRYPTOSTORAGEPLUGIN_PLUGIN_H
