...
public:
    ...
    virtual Sailfish::Secrets::Result collectionNames(QMap<QString, bool> *names) const = 0; // map of name to isLocked
...
public:
    ...
    Sailfish::Secrets::Result collectionNames(QMap<QString, bool> *names) const Q_DECL_OVERRIDE;
