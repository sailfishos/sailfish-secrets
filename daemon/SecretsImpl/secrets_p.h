...
class SecretsDBusObject : public QObject, protected QDBusContext
{
    ...
    "          <arg name=\"storagePlugins\" type=\"a(ssii)\" direction=\"out\" />\n"
    "          <arg name=\"encryptionPlugins\" type=\"a(ssii)\" direction=\"out\" />\n"
    "          <arg name=\"encryptedStoragePlugins\" type=\"a(ssii)\" direction=\"out\" />\n"
    "          <arg name=\"authenticationPlugins\" type=\"a(ssii)\" direction=\"out\" />\n"
