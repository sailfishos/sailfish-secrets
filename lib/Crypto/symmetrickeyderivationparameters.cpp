...
#include "Crypto/symmetrickeyderivationparameters_p.h"

using namespace Sailfish::Crypto;

SymmetricKeyDerivationParametersPrivate::SymmetricKeyDerivationParametersPrivate()
    : QSharedData()
...
SymmetricKeyDerivationParametersPrivate::SymmetricKeyDerivationParametersPrivate(
        const SymmetricKeyDerivationParametersPrivate &other)
    : QSharedData(other)
...
/*!
 * \class SymmetricKeyDerivationParameters
 ...
 *
 * \code
 * Sailfish::Crypto::SymmetricKeyDerivationParameters kdfParams;
 ...
 * in the SymmetricKeyDerivationParameters instance will be ignored.
...
/*!
 * \brief Constructs a new, empty SymmetricKeyDerivationParameters instance
 */
SymmetricKeyDerivationParameters::SymmetricKeyDerivationParameters()
    : d_ptr(new SymmetricKeyDerivationParametersPrivate)
{
}

/*!
 * \brief Constructs a copy of the \a other SymmetricKeyDerivationParameters instance
 */
SymmetricKeyDerivationParameters::SymmetricKeyDerivationParameters(
        const SymmetricKeyDerivationParameters &other)
    : d_ptr(other.d_ptr)
{
}

/*!
 * \brief Destroys the SymmetricKeyDerivationParameters instance
 */
SymmetricKeyDerivationParameters::~SymmetricKeyDerivationParameters()
{
}
...
/*!
 * \brief Assigns the \a other SymmetricKeyDerivationParameters instance to this
 */
SymmetricKeyDerivationParameters&
SymmetricKeyDerivationParameters::operator=(
        const SymmetricKeyDerivationParameters &other)
{
    d_ptr = other.d_ptr;
    return *this;
 ...
 */
bool SymmetricKeyDerivationParameters::operator==(const SymmetricKeyDerivationParameters &other) const
{
 ...
 */
bool SymmetricKeyDerivationParameters::isValid() const
{
 ...
 */
QByteArray SymmetricKeyDerivationParameters::inputData() const
{
 ...
 */
void SymmetricKeyDerivationParameters::setInputData(const QByteArray &data)
{
 ...
 */
QByteArray SymmetricKeyDerivationParameters::salt() const
{
    return d_ptr->m_salt;
}
 ...
 */
void SymmetricKeyDerivationParameters::setSalt(const QByteArray &salt)
{
    d_ptr->m_salt = salt;
}
...
SymmetricKeyDerivationParameters::keyDerivationFunction() const
{
 ...
 */
void SymmetricKeyDerivationParameters::setKeyDerivationFunction(
...
SymmetricKeyDerivationParameters::keyDerivationMac() const
{
 ...
 */
void SymmetricKeyDerivationParameters::setKeyDerivationMac(
...
SymmetricKeyDerivationParameters::keyDerivationAlgorithm() const
{
 ...
 */
void SymmetricKeyDerivationParameters::setKeyDerivationAlgorithm(
...
SymmetricKeyDerivationParameters::keyDerivationDigestFunction() const
{
 ...
 * client.
 */
void SymmetricKeyDerivationParameters::setKeyDerivationDigestFunction(
 ...
 */
qint64 SymmetricKeyDerivationParameters::memorySize() const
{
 ...
 */
void SymmetricKeyDerivationParameters::setMemorySize(qint64 size)
{
 ...
 * applicable for your case.
 */
int SymmetricKeyDerivationParameters::iterations() const
{
 ...
 */
void SymmetricKeyDerivationParameters::setIterations(int iterations)
{
 ...
 * applicable for your case.
 */
int SymmetricKeyDerivationParameters::parallelism() const
{
 ...
 */
void SymmetricKeyDerivationParameters::setParallelism(int parallelism)
{
 ...
 */
int SymmetricKeyDerivationParameters::outputKeySize() const
{
 ...
 */
void SymmetricKeyDerivationParameters::setOutputKeySize(int size)
{
 ...
 */
QVariantMap SymmetricKeyDerivationParameters::customParameters() const
{
 ...
 */
void SymmetricKeyDerivationParameters::setCustomParameters(const QVariantMap &params)
{
