...
#ifndef LIBSAILFISHCRYPTO_CRYPTODAEMONCONNECTION_P_P_H
#define LIBSAILFISHCRYPTO_CRYPTODAEMONCONNECTION_P_P_H
...
#endif // LIBSAILFISHCRYPTO_CRYPTODAEMONCONNECTION_P_P_H
