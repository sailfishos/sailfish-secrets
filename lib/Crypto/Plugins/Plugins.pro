...
develheaders_cryptoplugins.path = /usr/include/Sailfish/Crypto/Plugins/
develheaders_cryptoplugins.files = $$HEADERS
...
QMAKE_PKGCONFIG_INCDIR = $$develheaders.path $$develheaders_cryptoplugins.path
...
INSTALLS += develheaders_cryptoplugins
