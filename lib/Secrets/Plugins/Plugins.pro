...
develheaders_secretsplugins.path = /usr/include/Sailfish/Secrets/Plugins/
develheaders_secretsplugins.files = $$HEADERS
...
QMAKE_PKGCONFIG_INCDIR = $$develheaders.path $$develheaders_secretsplugins.path
...
INSTALLS += develheaders_secretsplugins
