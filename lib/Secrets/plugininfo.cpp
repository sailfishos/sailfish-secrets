...
#include "Secrets/plugininfo_p.h"
 ...
 */
PluginInfo::PluginInfo(const QString &name, int version, PluginInfo::StatusFlags status)
 ...
 */
bool Sailfish::Secrets::operator==(const PluginInfo &lhs, const PluginInfo &rhs)
{
