...
#ifndef SAILFISHSECRETS_PLUGIN_ENCRYPTION_OPENSSL_EVP_P_H
#define SAILFISHSECRETS_PLUGIN_ENCRYPTION_OPENSSL_EVP_P_H
...
#endif // SAILFISHSECRETS_PLUGIN_ENCRYPTION_OPENSSL_EVP_P_H
